...
- Real Android/iOS AdMob app IDs in native configuration.
...
- App retention: `app_session_start`, `app_lifecycle`
- Gameplay: `game_start`, `game_complete`, `game_exit`
- Content/difficulty: `content_start`, `content_complete`, `game_feedback`
- Parent/settings: `parent_gate_result`, `settings_open`, `settings_change`, `progress_reset`
- Ad impact: `ad_opportunity`, `ad_init`, `ad_load`, `ad_show`, `ad_impression`, `ad_click`, `ad_dismiss`, `ad_error`
